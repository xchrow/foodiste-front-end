        ...
        <v-dialog v-model="dialog" max-width="900" content-class="v-dialog--custom">
            <v-container class="pa-6">
                    ...
                    <div>
                        <form @submit.prevent="submit">
                            <v-text-field class="pa-2" v-model="pseudo" :rules="pseudoRules" type="text"
                                ...
                                <v-text-field class="pa-2" v-model="NomBlog" :rules="NomBlogRules" type="text"
                                label="Choisir un nom du blog" variant="outlined"></v-text-field>
                                ...
                                <v-btn variant="tonal" type="submit" class="btn-pers ma-1" id="login_button">Créer un compte</v-btn>
                        </form>
                    </div>
                </div>
                ...
                <v-list-item class="pt-5 justify-center">
                    <div class="pb-2">Compte déjà existant ?</div>
                    <v-btn variant="tonal" type="submit" class="btn-pers" id="register_button" router-link to="/login">
                        Se connecter</v-btn>  
